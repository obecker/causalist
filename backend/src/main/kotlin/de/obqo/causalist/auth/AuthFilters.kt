//package de.obqo.causalist.auth
...
//
//    /**
//     * using auto-refreshed bearer token
//     */
//
...
//    }
//
//    val lens = Query.int().optional("dummy")
//
//    return routes(
...
//        // api key
//        "api" bind GET to ServerFilters.ApiKeyAuth(Cookies.optional("key")) { it?.value == "foo"}.then(endpoint),
