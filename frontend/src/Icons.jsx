...
export function WrittenPreliminaryProcedureIcon({className}) {
    return (
        <Svg className={className}>
            <path fill="none" strokeWidth="1.2" strokeLinejoin="round" strokeLinecap="round"
...
export function AppraisersReportIcon({className}) {
    return (
        <Svg className={className}>
            ...
            <path strokeWidth="0" fillRule="evenodd"
...
export function SessionIcon({className}) {
    return (
        <Svg className={className}>
            <path strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round"
